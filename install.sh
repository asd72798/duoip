...
if [ $value -eq 1 ]; then
    yum update
    bash <(curl -s -L https://github.com/cx9208/bbrplus/raw/master/ok_bbrplus_centos.sh)
...
if [ $? == 0 ]; then
   ...
   echo 
   bash <(curl -s -L https://raw.githubusercontent.com/asd72798/duoip/main/create_sk5.sh)  t.txt >/dev/null 2>&1
